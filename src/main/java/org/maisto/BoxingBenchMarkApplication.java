...
//@Fork(value = 2,jvmArgs = {"-Xms4G","-Xmx4G"})//It exetus the benchmarck 2 times to improve the reliability of results and uses 4Gb of heap space to limit the influence of garbage collector
